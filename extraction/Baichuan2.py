...
class Extraction:
    def __init__(self):
        ...
        self.model = AutoModelForCausalLM.from_pretrained("baichuan-inc/Baichuan2-13B-Base", torch_dtype=torch.float16, trust_remote_code=True)
        ...
        self.example_input1 = "你好，我想要采购一个O型圈但不太确定具体型号 我需要一个应用于橡塑成形密封圈 内径:64.4, 材质:10, 横截面直径:3.1"
        self.example_output1 = '{"品类要求": "橡塑成形密封","技术属性要求": {"内径": "64.4","材质": "10","横截面直径": "3.1"}}'
        self.example_input2 = "你好，我想要采购一个密封垫片但不太确定具体型号 我需要一个金属骨架橡胶密封垫片 内径:80, 外径:110, 厚度:3"
        self.example_output2 = '{"品类要求": "金属骨架橡胶密封垫片","技术属性要求": {"内径": "80","外径": "110","厚度": "3"}}'
        self.example_input3 = "[{'user': '你好，我想要采购一个单列深沟球轴承但不太确定具体型号 我需要一个滚动轴承 内径:45, 外径:100, 宽度:25",
        self.example_output3 = '{"品类要求": "滚动轴承","技术属性要求": {"内径": "45","外径": "100","宽度": "25"}}'
        self.prompt = f"{self.example_input1}->{self.example_output1}\n{self.example_input2}->{self.example_output2}\n{self.example_input3}->{self.example_output3}"

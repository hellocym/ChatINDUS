...
class Extraction:
    def __init__(self):
        ...
        egs = [
            ...
            '输入：{"input":[{"user":"你好，我想要采购一个轴承，不太确定具体型号。","agent":"您好！有很多种轴承，例如深沟球轴承、圆锥滚子轴承、推力轴承等。您能描述一下您的需求或应用场景吗？"},{"user":"我需要一个应用于电机的轴承，要求转速较高，单列的。","agent":"了解了。那您可能需要一个深沟球轴承，它适合于高速旋转的应用场景。关于轴承的具体尺寸，您能提供一下内径、外径和宽度的要求吗？"},{"user":"内径12mm，外径37mm，宽度12mm。","agent":"好的，我已经记录了您的要求。我们有符合您描述的深沟球轴承，我会尽快为您提供采购详情。"}]}',
